...
sealed class VsideAgeRange(val serverDataStr: String) {
    object Age0to9: VsideAgeRange("0~9")
    object Age10to14: VsideAgeRange("10~14")
    object Age15to19: VsideAgeRange("15~19")
    object Age20to29: VsideAgeRange("20~29")
    object Age30to39: VsideAgeRange("30~39")
    object Age40to49: VsideAgeRange("40~49")
    object Age50to59: VsideAgeRange("50~59")
    object Age60to69: VsideAgeRange("60~69")
    object Age70to79: VsideAgeRange("70~79")
    object Age80to89: VsideAgeRange("80~89")
    object Age90Above: VsideAgeRange("90~")
    companion object {
